...
def rtl_css():
    st.markdown(
        ...
        @media (max-width: 768px) {
            ...
            /* جعل التبويبات قابلة للتمرير بدل الانضغاط */
...
def main():
    ...
    criterion_options = [f"{row['criterion_code']} - {row['criterion_text'][:70]}" for row in visible_rows]
