...
def main():
    ...
    st.markdown(
        ...
        <div class="main-title">
            ...
            <p>نسخة Python تفاعلية لمساعدة البرامج الأكاديمية في اختيار الشواهد، وتقييم الجاهزية، وتوليد تقرير فجوات الاعتماد.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="criterion-box">
            ...
            {'<span class="essential-badge">محك أساسي</span>' if selected_row['essential'] else ''}
